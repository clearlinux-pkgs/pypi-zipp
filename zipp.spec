...
Source0  : https://files.pythonhosted.org/packages/11/b5/89f3ab6d45b2709863761bab58c574b2344ef215749abb5407818c21c9ca/zipp-2.1.0.tar.gz
...
%prep
%setup -q -n zipp-2.1.0
cd %{_builddir}/zipp-2.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580144074
...
cp %{_builddir}/zipp-2.1.0/LICENSE %{buildroot}/usr/share/package-licenses/zipp/8e6689d37f82d5617b7f7f7232c94024d41066d1
