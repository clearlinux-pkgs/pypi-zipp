...
Source0  : https://files.pythonhosted.org/packages/7b/50/8a41d217ae898bb7a422a55a2a2afc22dfaab42b7bce5fe771a3892fe5e7/zipp-3.3.0.tar.gz
...
%prep
%setup -q -n zipp-3.3.0
cd %{_builddir}/zipp-3.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602529290
...
cp %{_builddir}/zipp-3.3.0/LICENSE %{buildroot}/usr/share/package-licenses/zipp/8e6689d37f82d5617b7f7f7232c94024d41066d1
