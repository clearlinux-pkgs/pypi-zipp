...
Source0  : https://files.pythonhosted.org/packages/49/4d/374ccacda17692db1d93b00a637b8255ec97608b0c51f3b66bc9c57fe3e1/zipp-3.3.1.tar.gz
...
%prep
%setup -q -n zipp-3.3.1
cd %{_builddir}/zipp-3.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602864514
...
cp %{_builddir}/zipp-3.3.1/LICENSE %{buildroot}/usr/share/package-licenses/zipp/8e6689d37f82d5617b7f7f7232c94024d41066d1
