...
%prep
%setup -q -n zipp-3.4.0
cd %{_builddir}/zipp-3.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603736400
...
cp %{_builddir}/zipp-3.4.0/LICENSE %{buildroot}/usr/share/package-licenses/zipp/8e6689d37f82d5617b7f7f7232c94024d41066d1
