...
Source0  : https://files.pythonhosted.org/packages/d1/2f/ba544a8a6ad5ad9dcec1b00f536bb9fb078f5f50d1a1408876de18a9151b/zipp-3.13.0.tar.gz
...
%prep
%setup -q -n zipp-3.13.0
cd %{_builddir}/zipp-3.13.0
pushd ..
cp -a zipp-3.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676046005
